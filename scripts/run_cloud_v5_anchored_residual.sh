...
MODEL_VERSION="${V5_MODEL_VERSION:-v5.2}"
OUTPUT_ROOT="${V5_OUTPUT_ROOT:-artifacts/v5_2_content_rescue}"
...
EVIDENCE_SOURCE="${V5_EVIDENCE_SOURCE:-content}"
MAX_CONFLICT_GAP="${V5_MAX_CONFLICT_GAP:-2}"
ANCHOR_RUN_NAME="${V5_ANCHOR_RUN_NAME:-exp01_anchor_content}"
MULTIVIEW_RUN_NAME="${V5_MULTIVIEW_RUN_NAME:-exp02_multiview_content}"
